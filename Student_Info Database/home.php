...
<body>
  <header >
    <div class="head">
      ...
      <h1 style="color: black;" >I0T Based RFID<br>
      Attendance System</h1>
    </div>
    <br><br>
    <a href="view.php">Attendance Log</a>
    <br><br><br>
    <a href="addCard.php">Add a new Student</a>
    <!-- <a href="view.php">Attendance Log</a> -->
  </header>
    ...
    <div class="opt">
        <form action="view.php" method="POST" >
        	<table>
        		<tr>
<tr>
  <select style="height: 1.8em;" class="form-control" id="Type" name="type" required="">
    <option value="1">CSE 324 : Computer Networks Lab (A)</option>
    <option value="2">CSE 324 : Computer Networks Lab (B)</option>
    <option value="3">CSE 324 : Computer Networks Lab (C)</option>
  </select>
  </tr>
  <tr>
        <td>Course Teacher: Mr. Mohammad Mamun Elahi</td>
      </tr>
...
<!--             	    <td><input type="submit" value="Add" name="login" id="lo"></td>
    ...
    <input class="btn btn-default submit " type="submit" name="submit1" id="lo" value="Go!">
           		 </tr>
