...
const char *ssid = "UIU-STUDENT";  //ENTER YOUR WIFI SETTINGS                                              //Changed
const char *password = "12345678";                                                                         //Changed  

//Web/Server address to read/write from 
const char *host = "10.10.253.190";   //IP address of server                                               //Changed
...
void loop() {
 ...
 for (byte i = 0; i < mfrc522.uid.size; i++) {
  ...
  Link = "http://10.10.253.190/loginsystem/postdemo.php" + getData;                                            //Changed
